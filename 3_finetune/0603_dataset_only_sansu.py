...
data_folder="data/0603only_sansu"
...
ds_dict["sansu"]=calc_problems

# %%
# マルチターン　自動生成
# せっかくなので、マルチターンくらいはいれておく
ds=load_dataset("kanhatakeyama/AutoMultiTurnByMixtral8x22b",)["train"]
ds.shuffle()


n_multi_turn=2*10**4 #このマルチターンは、回答が短いケースが多いので、少なめにしておく
...
# %%
# meta math
#数学的な基礎力が低く、勉強してもあまり意味がなさそう. 出力がgptらしいので不可
"""
